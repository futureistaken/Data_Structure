...
Discussion: Implementation -- PointUtility Class
Writen by: Babak
Due date: 2016/12/13
*/
				...
				do {
					...
					case 1:
						if (firstPoint == nullptr && secondPoint == nullptr)
							...
							cout << "\nYour first point is in the " << Quadrant << " Quadrant\n";
							Quadrant = secondPoint->getQuadrant();
							cout << "\nYour second points is in the " << Quadrant << " Quadrant\n";
							Quadrant = 0;
						}
						break;
					case 2:
						if (firstPoint == nullptr && secondPoint == nullptr)
							...
							do {
								...
								case 1:
									...
									break;
								case 2:
									cout << "\nYour second point respect to your first point is in "
